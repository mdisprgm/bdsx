...
const JsonUtil$GetBlockLegacy = procHacker.js(
...
BlockPalette.getBlockLegacy = BlockPalette.prototype.getBlockLegacy = function (blockName) {
    return JsonUtil$GetBlockLegacy(blockName);
};
...
Actor.prototype.getScoreTag = function () {
    return SynchedActorDataEntityWrapper$getString(this.getEntityData(), ActorDataIDs.ScoreTag);
};
...
Certificate.prototype.getXuid = function (): string {
    return ExtendedCertificate.getXuid(this, false);
};
...
Minecraft.prototype.getNetworkHandler = procHacker.js("?getServerNetworkSystem@Minecraft@@QEAAAEAVServerNetworkSystem@@XZ", NetworkSystem, { this: Minecraft });
