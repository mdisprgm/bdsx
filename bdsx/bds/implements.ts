...
BlockPalette.prototype.getBlockLegacy = procHacker.js(
...
Actor.prototype.getScoreTag = procHacker.js("?getScoreTag@Actor@@UEBAAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ", CxxString, {
    this: Actor,
});
